...
import { createPublicClient, createWalletClient, http as viemHttp, parseAbi, type Address } from 'viem'
...
const CONTRACT_ADDRESS = (process.env.GAME_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000') as Address
